...
# Configuration
# Read models from data/raw_data (obj_01.ply -> obj_14.ply)
models_dir = Path(RAW_DATA_DIR)
# Save analysis outputs under data/preprocessed_data
output_dir = ensure_dir(PREPROCESSED_DATA_DIR)
...
def plot_individual(label, info, idx):
    ...
    verts = pyminiply.read(Path(RAW_DATA_DIR) / f"obj_{idx+1:02d}.ply")[0]
